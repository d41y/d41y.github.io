- [Search Your Data](#search-your-data)
  - [Discover and Data Visualizer](#discover-and-data-visualizer)
    - [Documents](#documents)
    - [Fields and Values](#fields-and-values)
    - [ES Data Types](#es-data-types)
    - [Text vs. Keyword](#text-vs-keyword)
    - [Data Visualizer](#data-visualizer)
    - [Discover](#discover)
    - [Context: time and data view](#context-time-and-data-view)
  ...
  - [KQL and Filters](#kql-and-filters)
    - [Search Recap](#search-recap)
    - [Query Context](#query-context)
    - [Better Queries, Better Results](#better-queries-better-results)
    - [Queries Precision](#queries-precision)
    - [Boolean Operators](#boolean-operators)
    - [KQL Suggestions](#kql-suggestions)
    - [Wildcard Query](#wildcard-query)
    - [Range Query](#range-query)
    - [Query Bar Limitations](#query-bar-limitations)
    - [Define a Filter](#define-a-filter)
    - [Define Complex Filters](#define-complex-filters)
    - [Filter Operations](#filter-operations)
    - [Editing Filters](#editing-filters)
    - [Filter and Query Bar](#filter-and-query-bar)
    - [Break down Histogram by Value](#break-down-histogram-by-value)
    - [Saved Searches](#saved-searches)
    - [Saved Queries](#saved-queries)
    - [Saved Query vs. Saved Search](#saved-query-vs-saved-search)
  - [Field Focus](#field-focus)
    - [Visualization Basics](#visualization-basics)
    - [The Shortest Path to Visualization](#the-shortest-path-to-visualization)
    - [Focus with Lens](#focus-with-lens)
    - [Change the Visual](#change-the-visual)
    - [Change the Values](#change-the-values)
    - [Get Suggestions](#get-suggestions)
    - [Map your Data](#map-your-data)
    - [Using Visualizations](#using-visualizations)
