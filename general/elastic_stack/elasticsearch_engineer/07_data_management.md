- [Data Management](#data-management)
  - [Data Management Concepts](#data-management-concepts)
    ...
    - [Index Aliases](#index-aliases)
      - [Scaling Indices](#scaling-indices)
      - [Using Aliases](#using-aliases)
      - [An Alias to Multiple Indices](#an-alias-to-multiple-indices)
    - [Index Templates](#index-templates)
      - [What are Index Templates?](#what-are-index-templates)
      - [Elements of an Index Template](#elements-of-an-index-template)
      - [Defining an Index Template](#defining-an-index-template)
      - [Applying an Index Template](#applying-an-index-template)
  ...
  - [Data Streams](#data-streams)
    ...
    - [Choosing the right Data Stream](#choosing-the-right-data-stream)
    - [Data Stream Naming Convention](#data-stream-naming-convention)
    - [Example Use of Data Streams](#example-use-of-data-streams)
    - [Creating a Data Stream](#creating-a-data-stream)
      - [Step 1](#step-1)
      - [Step 2](#step-2)
      - [Step 3](#step-3)
    - [Rollover a Data Stream](#rollover-a-data-stream)
    - [Changing a Data Stream](#changing-a-data-stream)
    - [Reindexing a Data Stream](#reindexing-a-data-stream)
  - [Index Lifecycle Management](#index-lifecycle-management)
    - [Data Tiers](#data-tiers)
      - [What is a data tier?](#what-is-a-data-tier)
      - [Overview of the Five Data Tiers](#overview-of-the-five-data-tiers)
      - [Data Tiers, Nodes, and Indices](#data-tiers-nodes-and-indices)
      - [Configuring an Index to Prefer a Data Tier](#configuring-an-index-to-prefer-a-data-tier)
    - [Index Lifecycle Management](#index-lifecycle-management-1)
      - [ILM Actions](#ilm-actions)
      - [ILM Policy Example](#ilm-policy-example)
      - [Define the Hot Phase](#define-the-hot-phase)
      - [Define the Warm Phase](#define-the-warm-phase)
      - [Define the Cold Phase](#define-the-cold-phase)
      - [Define the Delete Phase](#define-the-delete-phase)
      - [Applying the Policy](#applying-the-policy)
      - [Create an Index Template](#create-an-index-template)
      - [Start Indexing Documents](#start-indexing-documents)
      - [Troubleshooting Lifecycle Rollovers](#troubleshooting-lifecycle-rollovers)
      - [Agent and ILM](#agent-and-ilm)
  - [Searchable Snapshots](#searchable-snapshots)
    - [Cost Effective Storage](#cost-effective-storage)
    - [Snapshots](#snapshots)
      - [Disaster Recovery](#disaster-recovery)
      - [Snapshot and Restore](#snapshot-and-restore)
      - [Types of Repos](#types-of-repos)
      - [Setting Up a Repo](#setting-up-a-repo)
      - [Taking a Snapshot Manually](#taking-a-snapshot-manually)
      - [Automating Snapshots](#automating-snapshots)
      - [Restoring from a Snapshot](#restoring-from-a-snapshot)
    - [Searchable Snapshots](#searchable-snapshots-1)
      - [How Searchable Snapshots Work](#how-searchable-snapshots-work)
      - [Setting up Searchable Snapshots](#setting-up-searchable-snapshots)
      - [Add Searchable Snapshots to ILM](#add-searchable-snapshots-to-ilm)
