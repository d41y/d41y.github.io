- [Introduction to Networking](#introduction-to-networking)
  - [Structure](#structure)
    - [Network Types](#network-types)
      - [Wide Area Network (_WAN_)](#wide-area-network-wan)
      - [Local Area Netwotks (_LAN_) / Wireless Local Area Network (_WLAN_)](#local-area-netwotks-lan--wireless-local-area-network-wlan)
      - [Virtual Private Network (_VPN_)](#virtual-private-network-vpn)
        - [Site-to-Site VPN](#site-to-site-vpn)
        - [Remote Access VPN](#remote-access-vpn)
        - [SSL VPN](#ssl-vpn)
    - [Book Terms](#book-terms)
      - [Global Area Network (_GAN_)](#global-area-network-gan)
      - [Metropolitan Area Network (_MAN_)](#metropolitan-area-network-man)
      - [Personal Area Network (_PAN_) / Wireless Personal Area Network (_WPAN_)](#personal-area-network-pan--wireless-personal-area-network-wpan)
    - [Topologies](#topologies)
      - [Connections](#connections)
      - [Nodes - Network Interface Controller (_NICs_)](#nodes---network-interface-controller-nics)
      - [Classifications](#classifications)
    - [Proxies](#proxies)
      - [Dedicated Proxy / Forward Proxy](#dedicated-proxy--forward-proxy)
      - [Reverse Proxy](#reverse-proxy)
      - [(Non-) Transparent Proxy](#non--transparent-proxy)
  - [Workflow](#workflow)
  ...
  - [Addressing](#addressing)
    ...
    - [IPv4 Addresses](#ipv4-addresses)
      ...
      - [Network and Gateway Addresses](#network-and-gateway-addresses)
      - [Broadcast Address](#broadcast-address)
      - [Classless Inter-Domain Routing - (_CIDR_)](#classless-inter-domain-routing---cidr)
    - [Subnetting](#subnetting)
    - [MAC Address](#mac-address)
      - [Adress Resolution Protocol (_ARP_)](#adress-resolution-protocol-arp)
    - [IPv6 Addresses](#ipv6-addresses)
  - [Protocols and Terminology](#protocols-and-terminology)
    ...
    - [Wireless Networks](#wireless-networks)
      ...
      - [WEP Challenge-Response Handshake](#wep-challenge-response-handshake)
  ...
  - [Connection Establishment](#connection-establishment)
    ...
    - [TCP/UDP Connections](#tcpudp-connections)
      - [IP Packet](#ip-packet)
        - [IP Header](#ip-header)
        - [IP Record-Route Field](#ip-record-route-field)
