- [Network Enumeration with Nmap](#network-enumeration-with-nmap)
  ...
  - [Host and Port Scannnig](#host-and-port-scannnig)
  ...
  - [Service Enumeration](#service-enumeration)
    ...
    - [Banner Grabbing](#banner-grabbing)
      - [Tcpdump](#tcpdump)
      - [Nc](#nc)
      - [Tcpdump - Intercepted Traffic](#tcpdump---intercepted-traffic)
  - [Nmap Scripting Engine (_NSE_)](#nmap-scripting-engine-nse)
    - [Script Defining](#script-defining)
      - [Default Scripts](#default-scripts)
      - [Specific Scripts Category](#specific-scripts-category)
      - [Defined Scripts](#defined-scripts)
      - [Example - Specifying Scripts](#example---specifying-scripts)
