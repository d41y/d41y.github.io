- [AD Domain Trust Attacks](#ad-domain-trust-attacks)
  ...
  - [Attacking Domain Trusts from Linux](#attacking-domain-trusts-from-linux)
    - [Performing DCSync with secretsdump.py](#performing-dcsync-with-secretsdumppy)
    - [Performing SID Brute Forcing using lookupsid.py](#performing-sid-brute-forcing-using-lookupsidpy)
    - [Looking for the Domain SID](#looking-for-the-domain-sid)
    - [Grabbing the Domain SID \& Attaching to Enterprise Admin's RID](#grabbing-the-domain-sid--attaching-to-enterprise-admins-rid)
    - [Constructing a Golden Ticket using ticketer.py](#constructing-a-golden-ticket-using-ticketerpy)
    - [Setting the KRB5CCNAME Environment Variable](#setting-the-krb5ccname-environment-variable)
    - [Getting a SYSTEM shell using Impacket's psexec.py](#getting-a-system-shell-using-impackets-psexecpy)
    - [Performing the Attack with raiseChild.py](#performing-the-attack-with-raisechildpy)
    - [Performing the Attack with raiseChild.py](#performing-the-attack-with-raisechildpy-1)
