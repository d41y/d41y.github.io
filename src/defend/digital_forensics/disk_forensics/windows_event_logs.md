...
If you want the event logs based on a date range (_5/28/23 - 6/2/23_), this can be done as follows.
...
You might wonder how you could have been aware of `Event.EventData.Data`. The Windows XML EventLog format can be found [here](https://github.com/libyal/libevtx/blob/main/documentation/Windows%20XML%20Event%20Log%20(EVTX).asciidoc).
...
6. Filtering event with FilterXPath
...
![windows event logs 43](../../../images/windows_event_logs43.png)
